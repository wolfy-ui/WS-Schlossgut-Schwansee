...
export function WorkshopSlideshow2() {
  ...
  const slides = [
        ...
        <div className={`space-y-6 transition-opacity duration-500 ${
          ...
          <div className="bg-gray-50 border border-gray-200 p-6 rounded-lg shadow-sm">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">
              Designing the Good Future – Understanding AI
            </h2>
            
            <div className="relative w-full aspect-video mb-6">
              <iframe
                className="absolute top-0 left-0 w-full h-full rounded-lg"
                src="https://www.youtube.com/embed/Wd5_tpM8wd0"
                title="Designing the Good Future"
            ...
            <div className="mt-6 space-y-4">
              <div>
                <a 
                  href="https://www.youtube.com/watch?v=Wd5_tpM8wd0" 
                  target="_blank" 
                ...
                >
                  ...
                  <span>Designing the Good Future, Understanding AI</span>
                </a>
              </div>
              
              <div className="pt-4 border-t border-gray-200">
                <a 
                  href="https://www.youtube.com/watch?v=QIw4tyCdj28" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-blue-600 hover:text-blue-800 transition-colors flex items-center space-x-2"
                >
                  ...
                  <span>The AI Tsunami is Here: Keynote on Why Firms Must Act Now (30 min)</span>
                </a>
              </div>
            </div>
          </div>
...

    {
      ...
      content: () => (
        <div className={`space-y-6 transition-opacity duration-500 ${
          ...
          <div className="bg-gray-50 border border-gray-200 p-6 rounded-lg shadow-sm">
            <h3 className="text-xl font-bold text-gray-900 mb-4">Auswertung (5 Min)</h3>
            <div className="ml-4 space-y-2">
              <p className="text-gray-700">• Fassen Sie die wichtigsten Erkenntnisse zusammen</p>
              <p className="text-gray-700">• Identifizieren Sie die drei dringlichsten Bedürfnisse</p>
              <p className="text-gray-700">• Notieren Sie überraschende oder unerwartete Einsichten</p>
            </div>
          </div>
...

    {
      ...
      content: () => (
        <div className={`space-y-6 transition-opacity duration-500 ${
          ...
          <div className="bg-gray-50 border border-gray-200 p-6 rounded-lg shadow-sm">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Guppen</h3>
            <div className="ml-4 space-y-2">
              <p className="text-gray-700">4-5 Gruppen a 4-6 Personen</p>
            </div>
          </div>
        ...
        <div className={`space-y-6 transition-opacity duration-500 ${
          ...
          <div className="bg-gray-50 border border-gray-200 p-6 rounded-lg shadow-sm">
            ...
            <div className="ml-4 space-y-2">
              ...
              <p className="text-gray-700">• "Wie könnten wir...?"</p>
            </div>
          </div>
          <div className="bg-gray-50 border border-gray-200 p-6 rounded-lg shadow-sm">
            ...
            <div className="ml-4 space-y-2">
              ...
              <p className="text-gray-700">• Denken Sie als CEO / CFO</p>
    ...
    {
      title: "Crazy 8s Methode (jeder für sich)",
      content: () => (
        <div className={`space-y-8 transition-opacity duration-500 ${
          ...
          <div className="bg-gray-50 border border-gray-200 p-6 rounded-lg shadow-sm">
            ...
            <div className="ml-4 space-y-2">
              <p className="text-gray-700">• Je Feld 2 Minuten: Eine Lösungsskizze entwickeln</p>
    ...
    {
      title: "Solution Sketch (jeder für sich)",
      content: () => (
        <div className={`space-y-6 transition-opacity duration-500 ${
          isVisible ? 'opacity-100' : 'opacity-0'
        }`}>
